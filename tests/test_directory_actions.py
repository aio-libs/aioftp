...
@pytest.mark.asyncio
async def test_change_directory_not_exist(pair_factory, expect_codes_in_exception):
    async with pair_factory() as pair:
...
@pytest.mark.asyncio
async def test_exception_in_list(pair_factory, Server, expect_codes_in_exception):
