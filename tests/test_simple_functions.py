...
def test_parse_ls_date_of_leap_year():
    ...
    current_and_expected_dates = (
        # 2016 (leap)
        (datetime.datetime(year=2016, month=2, day=29), datetime.datetime(year=2016, month=2, day=29)),
        # 2017
        (datetime.datetime(year=2017, month=2, day=28), datetime.datetime(year=2016, month=2, day=29)),
        (datetime.datetime(year=2017, month=3, day=1), datetime.datetime(year=2016, month=2, day=29)),
        # 2018
        (datetime.datetime(year=2018, month=2, day=28), datetime.datetime(year=2016, month=2, day=29)),
        (datetime.datetime(year=2018, month=3, day=1), datetime.datetime(year=2020, month=2, day=29)),
        # 2019
        (datetime.datetime(year=2019, month=2, day=28), datetime.datetime(year=2020, month=2, day=29)),
        (datetime.datetime(year=2019, month=3, day=1), datetime.datetime(year=2020, month=2, day=29)),
        # 2020 (leap)
        (datetime.datetime(year=2020, month=2, day=29), datetime.datetime(year=2020, month=2, day=29)),
    )
